  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 -mt-8 font-[Times_New_Roman]">
      <h1 className="flex justify-center text-lg sm:text-xl md:text-xl font-bold mb-6 text-center">
        Switzerland Tourist Visa Process with Affordable Tour Packages – Explore Switzerland with <strong className="text-orange-500">VJC Overseas</strong>
      </h1>

      <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
        <div className="md:w-1/2 text-base text-justify leading-snug">
          <p>
            Dreaming of snow-capped mountains, crystal-clear lakes, and charming Alpine villages? Switzerland is a breathtaking travel destination known for its scenic landscapes, luxury experiences, and rich culture. Whether you want to visit the iconic Matterhorn, enjoy a train ride on the Glacier Express, or explore cities like Zurich, Geneva, and Lucerne — <strong className="text-black">VJC Overseas</strong> is your trusted partner in making it happen.
          </p>
          <p className="mt-3">
            We offer complete assistance with the Switzerland tourist visa process and provide affordable, customized Switzerland tour packages tailored to your budget and preferences. Along with visa guidance, our experts also curate special holiday itineraries, ensuring you enjoy every moment of your Swiss journey with ease. For travelers seeking expert advice, our <Link href="https://www.vjcoverseas.com" className="text-orange-500 font-bold">Best Visa Immigration Consultants</Link> are here to support you.
          </p>
        </div>
        <div className="md:w-1/2 w-full rounded-lg overflow-hidden">
          <Image
            src="/Zurich-Geneva-and-Lucerne.jpg"
      ...
      <p className="mb-6 text-base text-justify leading-snug">
        Our visa consultants at <strong className="text-black">VJC Overseas</strong> will help you collect, verify, and organize these documents for a seamless application experience.
      </p>
      ...
      <p className="mb-6 text-base text-justify leading-snug">
        With <strong className="text-black">VJC Overseas</strong>, your visa process becomes hassle-free, timely, and highly professional. For additional services like guided experiences, our <Link href="https://www.vjcoverseas.com/tours-ticketing" className="text-orange-500 font-bold">Tours and Ticketing Services</Link> provide seamless planning for your Swiss journey.
      </p>

      <h2 className="text-xl font-bold mb-3 text-[#00843D]">Affordable Switzerland Tour Packages</h2>
      <p className="mb-6 text-base text-justify leading-snug">
        Beyond visas, we specialize in creating affordable Switzerland travel packages suitable for families, solo travelers, couples, and groups. These packages are designed to ensure a memorable experience without exceeding your budget.
      </p>
      <ul className="list-disc list-inside mb-6 text-base text-justify space-y-1.5">
        ...
        <li>Scenic train rides like Glacier Express or Golden Pass Line</li>
        <li>Swiss Travel Pass options for easy intercity travel</li>
        <li>Local guides and multilingual tour support</li>
        <li>Visa, insurance, and foreign exchange assistance</li>
      </ul>
      <p className="mb-6 text-base text-justify leading-snug">
        For premium experiences, our <Link href="https://www.vjcoverseas.com/tours-ticketing/switzerland" className="text-orange-500 font-bold">Switzerland Luxury Holidays</Link> packages offer stays in five-star resorts, private transfers, gourmet dining, and curated city tours.
      </p>
      ...
      <p className="mb-6 text-base text-justify leading-snug">
        Many travelers rely on <strong className="text-black">VJC Overseas</strong> as trusted <Link href="https://www.vjcoverseas.com/visit-visas" className="text-orange-500 font-bold">Visit Visa Consultants</Link> for a smooth and reliable Switzerland visa and travel experience.
      </p>

      <h2 className="text-xl font-bold mb-3 text-[#00843D]">Begin Your Swiss Journey Today</h2>
      <p className="mb-6 text-base text-justify leading-snug">
  From the visa application to exploring the majestic beauty of Switzerland, <Link href="https://www.vjcoverseas.com" className="text-orange-500 font-bold">VJC Overseas</Link> is here to guide you every step of the way. Trust our expert team to deliver a smooth visa experience and unforgettable travel memories — all within your budget.
</p>
