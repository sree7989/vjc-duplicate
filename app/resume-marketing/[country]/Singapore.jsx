...
<div className="relative lg:p-4 bg-gradient-to-r my-10 from-orange-100 to-sky-100 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out w-fit mx-auto">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Cover Letters & CVs: We craft impactful cover letters that resonate with hiring managers and show your suitability for the role.</li>
      </ul>

      <h2 className="text-xl text-black font-semibold mt-4 mb-2">Salary Structure in Singapore</h2>
      <p className="mb-4">
        One of the key elements you need to understand when seeking a job in Singapore is the salary structure. Depending on your industry, qualifications, and experience, salaries can vary significantly. Here’s a breakdown:
      </p>
      <ul className="list-disc list-inside mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Expat-Friendly: Singapore is a global hub, and expats from around the world have made it their home. With a diverse cultural mix, living in Singapore is an enriching experience that allows you to enjoy global cuisine, explore parks, and attend vibrant events.</li>
      </ul>
      ...
      <p className="mb-4">
        If you’re ready to start your career in Singapore, <span className="text-orange-500">VJC Overseas</span> is here to help. Our resume marketing services are designed to give you the best chance at securing your dream job and experiencing all that Singapore has to offer.
      </p>

      <h2 className="text-xl text-blue-400 font-semibold mt-4 mb-2">Get in Touch Today:</h2>
      <p className="mb-4">
        Contact us to learn more about how our services can elevate your job search and help you land your ideal role in Singapore.
      </p>
