...
const LongTermWorkVisa = () => {
  ...
  , we provide end-to-end support for Indian professionals.
        ...
        <p>
          ...
          sponsored by a UK employer, making it ideal for professionals looking
          to advance their careers internationally. You can also explore{" "}
          <Link
          ...
          options for other skilled employment categories.
        </p>
        ...
        <ul>
          ...
          <li>
            Work in high-demand industries like IT, Healthcare, Finance,
        ...
        <p>
          ...
          accessible. The UK has a strong demand for Indian professionals in IT,
          healthcare, teaching, and skilled trades. Many Indians also explore{" "}
          <Link
        ...
        <ul>
          ...
          <li>
            Minimum salary threshold (generally £26,200/year or £10.75/hour)
          </li>
        ...
        <p>
          ...
          , your journey becomes smooth with{" "}
          <Link
          ...
          and complete guidance from experts. We offer job search assistance,
          IELTS support, documentation help, and settlement guidance. You may
          also consider the UK PR Visa if your long-term goal is permanent
          residency.
        </p>
