      ...
      <div className="max-w-6xl mx-auto px-4 py-10 font-[Times_New_Roman]">
        <h1 className="flex justify-center text-xl sm:text-2xl md:text-2xl font-bold mb-8 text-center">
          ...
          <div className="flex items-center gap-4 mb-6">
                                     <Image src="/itlayvisitvisa.png" alt="USA B1 Visa" width={300} height={250} className="" unoptimized />
        <p>
          Experience La Dolce Vita! Discover the enchanting charm of Italy with the Italy Visit Visa, your gateway to one of Europe’s most iconic destinations. Whether you're drawn by its timeless architecture, mouthwatering cuisine, or romantic landscapes, <span className="text-orange-500">VJC Overseas</span> is here to guide you through the Italy tourist visa process—step-by-step.
        </p>
        </div>
        <h2 className="text-xl mt-6 mb-2 font-semibold"> What is an Italy Visit Visa?</h2>
        <p>
          The Italy Visit Visa, also known as a Short-Stay Schengen Visa (Type C), allows Indian nationals to travel to Italy for tourism, family visits, or business purposes for up to 90 days within a 180-day period.
        </p>
        ...
        <p>To apply for an Italy Visit Visa, you’ll need to gather the following documents:</p>
        <ul className="list-disc list-inside">
        ...
        <p>
          At <span className="text-orange-500">VJC Overseas</span>, we simplify your travel dreams. Whether you're planning a honeymoon in Venice or a family trip to Rome, our expert visa consultants are just a call away.
        </p>
